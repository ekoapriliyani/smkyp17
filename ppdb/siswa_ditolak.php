...
$siswa = query("SELECT * FROM tbl_siswa_ditolak");
?>
    ...
    <div class="main-content">
        ...
        <nav class="navbar navbar-expand-lg bg-navbar shadow" data-bs-theme="dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Data Siswa Tidak Diterima</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="siswa_ditolak.php">Siswa Tidak Diterima</a>
                        </li>
                    </ul>
                </div>
            </div>
